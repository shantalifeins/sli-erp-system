...
export function VendorBulkUploadModal({ isOpen, onClose, onSuccess }: VendorBulkUploadModalProps) {
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      a.href = url;
      a.download = 'vendor_bulk_upload_template.xlsx';
    ...
    try {
      ...
      reader.onload = async () => {
        try {
          ...
          const response = await fetchWithAuth('/api/vendors/bulk-upload', token, {
            method: 'POST',
      ...
      <div className="bg-white rounded-xl shadow-2xl border border-slate-200 w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-800">Bulk Upload Vendors</h3>
              <p className="text-xs text-slate-500">Import multiple vendor profiles via Excel template</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="bg-blue-50/60 border border-blue-200 rounded-lg p-4 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-600">Download formatted Excel file with sample data and live vendor list.</p>
            </div>
            <button
          ...
          <div className="space-y-2">
            ...
            >
              ...
              {selectedFile ? (
                ...
                <label htmlFor="vendor-excel-upload" className="cursor-pointer space-y-3 block">
